...
//	private Obstaculo[] obstaculos;
	...
	public Juego() {
		...
		kyojin = new Kyojin(100, 240, 0.05, 0.15, 0);  //x, y, velocidad, tamaño
...
//		obstaculos = new Obstaculo[5];
	...
	public void tick() {
		...
		if (kyojin.chocasteConEntornoDerecho()) {
			kyojin.cambiarDeDireccion();
		}
		
		if (kyojin.chocasteConEntornoIzquierdo()) {
			kyojin.cambiarDeDireccion();
		}
		
		if (kyojin.chocasteConEntornoInferior()) {
			kyojin.cambiarDeDireccion();
		}
		
		if (kyojin.chocasteConEntornoSuperior()) {
			kyojin.cambiarDeDireccion();
		}
