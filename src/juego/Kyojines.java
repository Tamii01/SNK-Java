...
public class Kyojines {
	...
	public boolean chocaEntorno(Entorno entorno) {
		return x < tamaño / 1.30 || x > entorno.ancho() - tamaño / 1.30 || y < tamaño / 1.30 ||  y > entorno.alto() - tamaño / 1.30;// si lo divido por 2, se sale un poco m�s de la pantalla
	}
	
	public void cambiarDeDireccion() { // perseguirA(mikasa) ??
		angulo ++;
	}
